...
def run(model, hour):
    ...
    """ Departure """
    # 1st hour prediction with actual previous hour's ADR
    # load selected prediction time data
    ...
    for time in range(1,hour+1,1):
        ...
        # ngbr_arrival
        if model == 'ngbr':
            clf_arrival = NGBRegressor(**hyperparameters.ngbr_params_a)
        ...
        # lgbr_arrival
            ...
            clf_arrival = LGBMRegressor(**hyperparameters.lgbr_params_a)                                          
            clf_arrival.fit(X_train_a, y_train_a,
                            sample_weight = None,                   # Weights of training data
        ...
        # ngbr_departure
        if model == 'ngbr':             
            clf_departure = NGBRegressor(**hyperparameters.ngbr_params_d)                                 
        ...
        # lgbr_departure
            ...
            clf_departure = LGBMRegressor(**hyperparameters.lgbr_params_d)                                                            
            clf_departure.fit(X_train_d, y_train_d,
                            sample_weight = None,                   # Weights of training data
                            init_score = None,                      # Weights of training data
